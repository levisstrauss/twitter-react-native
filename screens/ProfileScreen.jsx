    ...
    const ProfileHeader = () => (
        <View style={styles.container}>
            <Image
                ...
                source={{
                    uri:'https://wallpapercave.com/wp/WVN2cWE.jpg',
                }}
            />
            ...
            <View style={styles.nameContainer}>
                <Text style={styles.profileName}>Levis Strauss</Text>
                <Text style={styles.profileHandle}>@levisstrauss</Text>
            </View>

            <View style={styles.profileContainer}>
                <Text style={styles.profileContainerText}>
                    CEO of CEOs. PhD, MSc, SED, HTML, CSS, JS, Evangelist Pro Expert S Rank
            ...
            <View style={styles.linkContainer}>
                <TouchableOpacity
                    ...
                    onPress={() => Linking.openURL('https://laraasts.com')}
                >
